...
/*
	public static void main(String[] args) {
		int[][] costs={{100,120,150,1000},{100},{38,24},{10,10}};
		int[][] prices={{110,110,200,2000},{100},{37,23},{11,12}};
		int[][] sales={{20,100,50,3},{134},{1000,643},{2,1}};
		String[][] items={{"Video Card","256M Mem","CPU/Mobo combo","Complete machine"},{"Service, at cost"},{"Letter","Postcard"},{"A","B"}};
		
		for(int i=0;i<items.length;i++){
			System.out.println(bestItem(costs[i], prices[i], sales[i], items[i]));
		}
